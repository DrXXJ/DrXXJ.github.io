...
let data = {
  cherry: {
    color: '#aa1111',
    size:  10,
    shape: scaleShape(ShapeCherry, .3),
    next:  'Maron',
  },
  Maron: {
    color: '#d6aa25',
    size:  20,
    shape: scaleShape(ShapeMaron, .2),
    next:  'Lemon',
  },
  Lemon: {
    color: '#fcc00c',
    size:  30,
    shape: scaleShape(ShapeLemon, .3),
    next:  'banana',
  },
  banana: {
    color: '#e6e609',
    size:  40,
    shape: scaleShape(ShapeBanana, .4),
    next: 'Nashi',
  },
  Nashi: {
    color: '#9ffc92',
    size:  50,
    shape: scaleShape(ShapeNashi, .5),
    next:  'Apple',
  },
  Apple: {
    color: '#991100',
    size:  60,
    shape: scaleShape(ShapeApple, 1),
  },
